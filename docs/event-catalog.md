...
| Event                       | Area   | Type    | Trigger                                                   | Source   | Properties                                                                                                                           | Group | Property Updates                                                                            | Status      |
| --------------------------- | ------ | ------- | --------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------- | ----------- |
| Create Job Button Clicked   | Hiring | Intent  | User clicks Create Job button on home page                | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `current_persona` | --    | --                                                                                          | Not Started |
| Job Posting Draft Created   | Hiring | Success | Server confirms job draft created (step 1 "Next")         | Backend  | `current_persona`, `job_id`, `job_title`, `company_name`, `job_location`, `job_status`, `job_verified`, `job_visibility` | `job` | `group(job): job_title, job_status, hiring_manager_user_id, created_by_user_id, created_at` | Not Started |
| Job Creation Failed         | Hiring | Failure | Server returns error on job creation                      | Backend  | `current_persona`, `error_reason`                                                                                        | --    | --                                                                                          | Not Started |
...
| Job Post Wizard Job Details Completed | Hiring | -- | User clicks "Next" on Job Details step                  | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name` | `job` | --                                                                                          | Not Started |
| Job Post Wizard Intake Mode Selected | Hiring | -- | User clicks "Next" or "Skip" on Understanding the Role step | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name`, `intake_mode` | `job` | --                                                                                 | Not Started |
| Sam Session Started         | Hiring | --      | Sam session initializes after user selects voice or text  | Frontend | `current_page_context`, `previous_page_context`, `entity_type`, `job_id`, `input_mode`, `session_id`, `mic_enabled`\*, `error_category`\*, `error_reason`\* | `job` | --                                                                             | Not Started |
| Sam Session Ended           | Hiring | --      | User clicks "End Session" or intake auto-completes        | Frontend | `current_page_context`, `previous_page_context`, `entity_type`, `job_id`, `input_mode`, `duration_seconds`, `ended_by`, `session_id` | `job` | --                                                                                          | Not Started |
| Job Post Wizard Role Requirements Completed | Hiring | -- | User clicks "Next" on Role Requirements step          | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name` | `job` | --                                                                                          | Not Started |
| Requirement Add Button Clicked | Hiring | --   | User clicks "+ Add" on Role Requirements step             | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name` | `job` | --                                                                                          | Not Started |
| Job Post Wizard Interview Questions Completed | Hiring | -- | User clicks "Next" on Interview Questions step      | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name`, `identity_verification_mode` | `job` | --                                                                       | Not Started |
| Question Add Button Clicked | Hiring | --      | User clicks "+ Add" on Interview Questions step           | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name` | `job` | --                                                                                          | Not Started |
| Screening Configuration Saved | Hiring | --    | Backend saves screening config                            | Backend  | `current_persona`, `job_id`, `job_title`, `company_name`, `job_location`, `job_status`, `job_verified`, `job_visibility`, `questions_count`, `ai_generated_questions_count`, `manual_questions_count`, `identity_verification_mode`, `intake_mode` | `job` | --                             | Not Started |
| Job Verification Code Send Button Clicked | Hiring | -- | User clicks "Send code" on Verify step              | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name` | `job` | --                                                                                          | Not Started |
| Job Post Wizard Verification Completed | Hiring | -- | Email verified successfully on Verify step             | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name` | `job` | --                                                                                          | Not Started |
| Job Post Wizard Verification Skipped | Hiring | -- | User clicks "Maybe later" on Verify step                | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name` | `job` | --                                                                                          | Not Started |
| Job Post Wizard Back Button Clicked | Hiring | -- | User clicks "Back" on any wizard step (2–5)             | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `job_id`, `step_number`, `step_name` | `job` | --                                                                                          | Not Started |
...
| Share Button Clicked        | Hiring | Intent  | User clicks Share button on a job                         | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `component`, `context_object_type`, `context_object_id`, `current_persona` | `job` | --                                                                                    | Not Started |
| Job Shared                  | Hiring | Success | Server confirms job link shared                           | Backend  | `job_id`, `share_channel`, `shared_by_user_id`, `share_source`, `current_persona`                                        | `job` | --                                                                                          | Not Started |
| Job Share Failed            | Hiring | Failure | Server returns error on share attempt                     | Backend  | `job_id`, `error_reason`, `error_category`, `share_source`, `current_persona`                                            | `job` | --                                                                                          | Not Started |
| Job Status Changed          | Hiring | --      | Job status updated                                        | Backend  | `job_id`, `from_status`, `to_status`, `current_persona`                                                                  | `job` | `group(job): job_status`                                                                    | Not Started |
| Invite Button Clicked       | Hiring | Intent  | User clicks Invite button on a job                        | Frontend | `job_id`                                                                                                                 | `job` | --                                                                                          | Not Started |
| Team Member Invited         | Hiring | Success | Server confirms invite sent                               | Backend  | `job_id`, `invited_role_label`, `invite_method`, `current_persona`                                                       | `job` | --                                                                                          | Not Started |
| Team Member Invite Failed   | Hiring | Failure | Server returns error on invite attempt                    | Backend  | `job_id`, `error_reason`, `error_category`, `current_persona`                                                            | `job` | --                                                                                          | Not Started |
...
| `action` (user_action)  | enum | event                     | `click`, `submit`, `toggle`                                                         | Login Started, Account Created, Intro Completed, Switch Persona Button Clicked, Create Job Button Clicked, Job Post Wizard Job Details Completed, Job Post Wizard Intake Mode Selected, Job Post Wizard Role Requirements Completed, Job Post Wizard Interview Questions Completed, Job Post Wizard Verification Completed, Job Post Wizard Verification Skipped, Job Post Wizard Back Button Clicked, Requirement Add Button Clicked, Question Add Button Clicked, Job Verification Code Send Button Clicked, Archive Job Button Clicked, Share Button Clicked |
| `step_name`             | enum | event                     | `job_details`, `understanding_the_role`, `role_requirements`, `interview_questions`, `verify` | Job Post Wizard Job Details Completed, Job Post Wizard Intake Mode Selected, Job Post Wizard Role Requirements Completed, Job Post Wizard Interview Questions Completed, Job Post Wizard Verification Completed, Job Post Wizard Verification Skipped, Job Post Wizard Back Button Clicked, Requirement Add Button Clicked, Question Add Button Clicked, Job Verification Code Send Button Clicked |
...
| `mic_enabled`             | boolean | event       | Sam Session Started                        |
...
| `step_number`            | number | event | Wizard step (1–5)                              | Job Post Wizard Job Details Completed, Job Post Wizard Intake Mode Selected, Job Post Wizard Role Requirements Completed, Job Post Wizard Interview Questions Completed, Job Post Wizard Verification Completed, Job Post Wizard Verification Skipped, Job Post Wizard Back Button Clicked, Requirement Add Button Clicked, Question Add Button Clicked, Job Verification Code Send Button Clicked |
...
| `session_id`          | string   | event              | Backend session identifier for Sam conversations                           | Sam Session Started, Sam Session Ended           |
| `job_location`        | string   | event              | Job location extracted from JD                                             | Job Posting Draft Created, Screening Configuration Saved, Job Posting Verified, Job Posting Published |
| `company_name`        | string   | event              | Company name                                                               | Job Posting Draft Created, Screening Configuration Saved, Job Posting Verified, Job Posting Published |
