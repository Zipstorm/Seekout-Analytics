...
| Event                       | Area   | Type    | Trigger                                                   | Source   | Properties                                                                                                                           | Group | Property Updates                                                                            | Status      |
| --------------------------- | ------ | ------- | --------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------- | ----------- |
| Create Job Button Clicked   | Hiring | Intent  | User clicks "+ Create job" button on job postings page    | Frontend | `action`, `action_value`, `current_page_context`, `previous_page_context`, `entity_type`, `component`, `current_persona` | --    | --                                                                                          | Not Started |
...
| Job Posting Draft Created   | Hiring | Success | Server creates job draft via POST /api/v1/core/job        | Backend  | `current_persona`, `job_id`, `job_title`, `company_name`, `job_location`, `job_status`, `job_verified`, `job_visibility` | `job` | `group(job): job_title, job_status, created_by_user_id, created_at`                         | Not Started |
...
| Job Posting Verified        | Hiring | Success | Backend verifies 6-digit code successfully                | Backend  | `current_persona`, `job_id`, `job_title`, `company_name`, `job_location`, `job_status`, `job_verified`, `job_visibility`, `questions_count`, `ai_generated_questions_count`, `manual_questions_count`, `identity_verification_mode`, `intake_mode` | `job` | `group(job): is_verified` | Not Started |
| Job Posting Published       | Hiring | Success | Backend publishes the job (core + jobflow endpoints)      | Backend  | `current_persona`, `job_id`, `job_title`, `company_name`, `job_location`, `job_status`, `job_verified`, `job_visibility`, `questions_count`, `identity_verification_mode`, `intake_mode` | `job` | `group(job): job_status, is_verified, job_visibility` | Not Started |
...
| Voice Session Setup Failed | _(removed — properties on `Sam Session Started`)_ | Voice failure info captured as `mic_enabled`, `error_category`, `error_reason` on `Sam Session Started` | May 2026 |
...
| `action` (user_action)  | enum | event                     | `click`, `submit`, `toggle`                                                         | Login Started, Account Created, Intro Completed, Switch Persona Button Clicked, Create Job Button Clicked, Job Post Wizard Job Details Completed, Job Post Wizard Intake Mode Selected, Job Post Wizard Role Requirements Completed, Job Post Wizard Interview Questions Completed, Job Post Wizard Verification Completed, Job Post Wizard Back Button Clicked, Requirement Add Button Clicked, Question Add Button Clicked, Job Verification Code Send Button Clicked, Job Post Wizard Verification Skipped, Archive Job Button Clicked |
| `step_name`             | enum | event                     | `job_details`, `understanding_the_role`, `role_requirements`, `interview_questions`, `verify` | Job Post Wizard Job Details Completed, Job Post Wizard Intake Mode Selected, Job Post Wizard Role Requirements Completed, Job Post Wizard Interview Questions Completed, Job Post Wizard Verification Completed, Job Post Wizard Back Button Clicked, Requirement Add Button Clicked, Question Add Button Clicked, Job Verification Code Send Button Clicked, Job Post Wizard Verification Skipped |
| `ended_by`              | enum | event                     | `user`, `completed`                                                                 | Sam Session Ended                                              |
| `intake_mode`           | enum | event                     | `voice`, `text`, `skipped`                                                          | Job Post Wizard Intake Mode Selected, Screening Configuration Saved, Job Posting Published |
...
| `error_category`        | enum | event                     | `network`, `permission`, `validation`, `server`, `timeout`, `hardware`, `connection` | All failure events (incl. Persona Update Failed), Sam Session Started (voice failure properties) |
...
| `step_number`            | number | event | Wizard step (1–5)                              | Job Post Wizard Job Details Completed, Job Post Wizard Intake Mode Selected, Job Post Wizard Role Requirements Completed, Job Post Wizard Interview Questions Completed, Job Post Wizard Verification Completed, Job Post Wizard Back Button Clicked, Requirement Add Button Clicked, Question Add Button Clicked, Job Verification Code Send Button Clicked, Job Post Wizard Verification Skipped |
...
| Property              | Type     | Scope              | Description                                                                | Used In                                          |
| --------------------- | -------- | ------------------ | -------------------------------------------------------------------------- | ------------------------------------------------ |
| `action_value`        | string   | event              | Specific UI element interacted with (snake_case)                           | Login Started, Account Created, Intro Completed, Switch Persona Button Clicked, Create Job Button Clicked, all Job Post Wizard step/interaction events, Archive Job Button Clicked |
| `current_page_context`| string   | event              | Page where event occurred (snake_case, `_` hierarchy)                      | Page Viewed, Login Started, Account Created, Intro Completed, Switch Persona Button Clicked, Create Job Button Clicked, Job Post Wizard Started, all Job Post Wizard step/interaction events, Sam Session Started, Sam Session Ended |
| `previous_page_context`| string  | event              | Previous page before current one                                           | Page Viewed, Login Started, Account Created, Intro Completed, Switch Persona Button Clicked, Create Job Button Clicked, all Job Post Wizard step/interaction events, Sam Session Started, Sam Session Ended |
| `component`           | string   | event              | UI container where action occurred                                         | Login Started, Account Created, Intro Completed, Switch Persona Button Clicked, Create Job Button Clicked, all Job Post Wizard step/interaction events, Archive Job Button Clicked |
| `entity_type`         | string   | event              | Business object being acted on                                             | Login Started, Account Created, Intro Completed, Switch Persona Button Clicked, Create Job Button Clicked, all Job Post Wizard step/interaction events, Sam Session Started, Sam Session Ended |
...
| `job_location`        | string   | event              | Job location extracted from JD (can be null)                               | Job Posting Draft Created, Screening Configuration Saved, Job Posting Verified, Job Posting Published |
