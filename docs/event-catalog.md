...
| Sam Session Started         | Hiring | --      | Sam session initializes after user selects voice or text  | Frontend | `current_page_context`, `previous_page_context`, `entity_type`, `job_id`, `input_mode`, `session_id`, `mic_enabled`\*, `error_category`\*, `error_reason`\* | `job` | --                                                                             | Live |
