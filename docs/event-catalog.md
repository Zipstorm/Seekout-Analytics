...
| Event                           | Area     | Type    | Trigger                                     | Source   | Properties                                                                                             | Group | Property Updates | Status      |
| ------------------------------- | -------- | ------- | ------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------ | ----- | ---------------- | ----------- |
| Profile Created                 | Prospect | Success      | AI generates initial profile from resume    | Backend  | `input_method`                                                                                         | --    | --               | Not Started |
| Profile Section Updated         | Prospect | Success      | User edits a profile section                | Frontend | `section`                                                                                              | --    | --               | Not Started |
| Custom Link Created             | Prospect | Success      | User creates a named shareable link         | Backend  | `link_name`, `is_job_specific` (boolean), `target_job_title` (optional), `target_company` (optional)   | --    | --               | Not Started |
