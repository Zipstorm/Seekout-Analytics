...
- **[Rule 9]** Schema Intent-Outcome row (Switch Persona Button Clicked / Persona Updated / Persona Update Failed) not in Dashboard Platform Health table
- **[Rule 9]** Schema Intent-Outcome row (Auth Phone Submitted / *(implicit — accepted)* / Auth Phone Submit Failed) not in Dashboard Platform Health table
- **[Rule 10]** `current_persona` is used in "Persona Updated" but not listed in Property Dictionary "Used In"
- **[Rule 10]** `current_persona` lists "Account Created" in "Used In" but that event does not reference this property
- **[Rule 10]** `current_persona` lists "Persona Updated (event property + person property)" in "Used In" but that event does not exist in the catalog
