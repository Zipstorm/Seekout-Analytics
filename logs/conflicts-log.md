...
- **[Rule 9]** Schema Intent-Outcome row (Auth Email Verify Code Sent / Auth Email Verified / Auth Email Verify Failed) not in Dashboard Platform Health table
- **[Rule 9]** Schema Intent-Outcome row (Login Started / Account Created (new) or Auth Login Succeeded (returning) / Login Cancelled, Auth Login Failed) not in Dashboard Platform Health table
- **[Rule 10]** `current_page_context` is used in "Persona Chevron Clicked" but not listed in Property Dictionary "Used In"
...
## Run: 2026-05-11 08:04:43 UTC

**Result: 12 errors, 5 warnings**
...
## Run: 2026-05-11 08:11:41 UTC

**Result: 14 errors, 5 warnings**
...
- **[Rule 9]** Schema Intent-Outcome row (Auth Email Verify Code Sent / Auth Email Verified / Auth Email Verify Failed) not in Dashboard Platform Health table
- **[Rule 9]** Schema Intent-Outcome row (Login Started / Account Created (new) or Auth Login Succeeded (returning) / Login Cancelled, Auth Login Failed) not in Dashboard Platform Health table
- **[Rule 10]** `entry_point` is used in "Login Started" but not listed in Property Dictionary "Used In"
- **[Rule 10]** `entry_point` lists "Login Started; Page Viewed ($set_once only)" in "Used In" but that event does not exist in the catalog
